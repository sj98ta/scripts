...
#Description:   The script builds Calico version v3.20.1 on Linux on IBM Z for RHEL (7.8, 7.9, 8.1, 8.2, 8.3), Ubuntu (18.04, 20.04, 21.04) and 
...
TESTS="false"
CURDIR="$(pwd)"
PATCH_URL="https://raw.githubusercontent.com/linux-on-ibm-z/scripts/master/Calico/3.20.0/patch"
...
EOF
    ...
    git clone -b v3.20.0-0.dev https://github.com/projectcalico/libcalico-go $GOPATH/src/github.com/projectcalico/libcalico-go
    git clone -b v3.20.0-0.dev https://github.com/projectcalico/confd $GOPATH/src/github.com/projectcalico/confd
